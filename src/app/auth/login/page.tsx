...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-indigo-600/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-sm relative animate-fade-in">
        ...
        <div className="bg-[#111113] rounded-2xl border border-[#27272a]/80 p-8 shadow-2xl shadow-black/40">
          <div className="mb-6">
            <h1 className="text-xl font-semibold text-[#fafafa] tracking-tight">Welcome back</h1>
            <p className="text-[13px] text-[#71717a] mt-1">Sign in to continue</p>
          </div>
